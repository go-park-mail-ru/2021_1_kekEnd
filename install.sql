...
(
    friend_1 INTEGER REFERENCES mdb.users (id) ON DELETE CASCADE,
    friend_2 INTEGER REFERENCES mdb.users (id) ON DELETE CASCADE,
...
(
    user_1 INTEGER REFERENCES mdb.users (id) ON DELETE CASCADE,
    user_2 INTEGER REFERENCES mdb.users (id) ON DELETE CASCADE,
