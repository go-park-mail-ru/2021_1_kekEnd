...
func (m *MockUserRepository) GetModels(arg0 []string, arg1 int) []*models.UserNoPassword {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) GetModels(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetModels", reflect.TypeOf((*MockUserRepository)(nil).GetModels), arg0, arg1)
}
