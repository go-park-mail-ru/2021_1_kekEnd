...
func RegisterHttpEndpoints(router *gin.Engine, playlistsUC playlists.UseCase, usersUC users.UseCase,
	...
	router.GET("/playlists/users/:user_id", handler.GetPlaylists)
